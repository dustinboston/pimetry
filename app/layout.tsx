  ...
  return (
    <html lang="en" className="dark">
      <body className={inter.className}>
        <main className="grid h-full w-full grid-cols-12 grid-rows-1 bg-yellow-800 bg-opacity-10">
          <nav className="col-span-2 flex flex-col divide-y-4 divide-yellow-800 divide-opacity-20 border-r-4 border-yellow-800 border-opacity-20">
            <menu
              aria-label="Page actions"
              className="w-full flex-none px-2 py-4"
            >
              <li>
                <button
                  title="Add page"
            ...
            >
              <option className="bg-yellow-800 bg-opacity-20 p-2">
                Foo Bar
              </option>
            </select>
            <menu
